  ...
  render() {
    ...
    return <>
      ...
      <div className="is-ui ui_save_content" style={{ "position": "fixed", "top": "20px", "right": "35px", "display": "flex", "justifyContent": "flex-end" }}>
        ...
        <button type="button" className="save-contenting" onClick={() => this.saveAndContinue()}>Save and Continue</button>
            ...
            <li className="menu" id="dropMenu">
              ...
              <ul id="uly" className="settings_empowers">
                ...
                <li className="setting-01">
                  <Link onClick={() => {
                    window.location.replace(`${DASHBOARD_URL}/auth/tutor-dashboard/content-builder`)
                  }}>
                    <div className="blue-box"></div>
                    Dashboard</Link>
                </li>
