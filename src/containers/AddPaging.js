...
function MyVerticallyCenteredModal(props) {
  ...
  const tutorCreate = async (e) => {
    ...
    const res = await authAxios.post(
      `${api_hosting}/learning-material/add`,
      params
    );
    ...
    if (res.status === 200) {
      ...
      const res_pages = await authAxios.post(
...
function AddPage() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const resp = await authAxios.get(
        `${api_hosting}/tutor/learning-material/fetch?page=1&limit=${limit}`
      );
  ...
  const fetchPagination = async (currentPage) => {
    ...
    const res = await authAxios.get(
      `${api_hosting}/tutor/learning-material/fetch?page=${currentPage}&limit=${limit}`
    );
