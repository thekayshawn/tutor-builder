              ...
              <>
                <li key={index}>
                  <div className="pages_image_show learner-side-page">
                    <button onClick={this.pageContent.bind(this, item)}>
                      <h2>{item.page_title}</h2>
                    </button>
                    {
                      /* <p class="more">{item.short_description}</p> */ console.log(
                        item.id
                      )
                    }
                  </div>
      ...
      <>
        <div className="tutor-save-data">
          ...
          <div className="data_page_delete">
            <button className="btn btn-danger" onClick={this.pageDelete}>
              Delete The Page
            </button>
          </div>
        </div>
