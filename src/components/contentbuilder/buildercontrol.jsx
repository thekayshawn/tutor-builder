...
class BuilderControl extends Component {
  ...
  getHTML = () => {
    return this.obj.html(document.getElementById("main_content"));
  };
  ...
  render() {
    return (
      <div
        id="main_content"
        className="container tutor-main-section-container elements_fulls_screens"
      ></div>
    );
  }
}
...
BuilderControl.defaultProps = {
  ...
  useLightbox: true,
  themes: [
    // color preview, class name & css file
    ["#ffffff", "", ""],
