...
$(document).on(
  "click",
  "div.quiz-questionnaire form h3, div.quiz-questionnaire form .quiz-explanation",
  function () {
...
$(document).on(
  "click",
  "div.quiz-questionnaire form input[type=radio]",
  function () {
...
$(document).on(
  "click",
  "div.quiz-questionnaire form input[type=checkbox]",
  function () {
    if ($("div[data-is-lerner=true]").length > 0) {
    } else {
...
$(document).on("click", "#medium-screen", function (e) {
  ...
  $(
    ".column.full,.column.half,.column.third,.column.fourth,.col-md-6"
  ).addClass("colhalf");
  $("#myModals").modal("show");
});
...
$(document).on(
  "click",
  ".option_boolean_ones .radio_mul_checked",
  function (each) {
    var id = $(this).attr("id");
...
$(document).on("click", ".correct-answer-btn", function () {
  if ($(this).closest("form").find(".multi-blank-div").length > 0) {
    ...
    $(this)
      ...
      .each(function () {
        var answers = $(this)
          .closest(".multi-blank-div")
          .find("input")
          .attr("data-multiblank-answers");
        ...
        var answer = $(this)
          ...
          .attr("data-multiblank-answers");
        var lerner_ans = $(
          "input[data-multiblank-answer=" + answer + "]"
        ).val();
        if (adm_ans != lerner_ans) {
          $(this)
            .closest(".multi-blank-div")
            .find("div.mcq-checked")
            .each(function () {
              var radio_val = $(this)
                .closest("div.mcq-checked")
                .find("input")
                .attr("id");
  ...
  //correct textarea
    ...
    $(this)
      .closest("form")
      .find(".boolean_question_response")
      .css("display", "block");
  }
  //Correct
  else if ($(this).closest("form").find(".multiple_bbolean_one").length > 0) {
    var slectedOpionts = $(this)
      .closest("form")
      .find(".multiple_bbolean_one")
      .val();
    ...
    if (slectedOpts === slectedOpionts) {
      ...
      $(this)
        .closest("form")
        .find("div.choiceGrouping")
        .each(function () {
          var radio_val = $(this)
            .closest("div.choiceGrouping")
            .find("input")
            .attr("id");
  ...
  //new
    ...
    if (slectedOpts === slectedOpionts) {
      ...
      $(this)
        .closest("form")
        .find("div.fillGrouping")
        .each(function () {
          var radio_val = $(this)
            .closest("div.fillGrouping")
            .find("input")
            .attr("id");
          console.log("aaaaa", radio_val);
          if (radio_val == slectedOpionts) {
  ...
  //Corrected
    ...
    var slectedOpiont = $(this)
      .closest("form")
      .find(".its-boolean-answer")
      .val();
    ...
    if (slectedOpt === slectedOpiont) {
      ...
      labels = $(this)
        .closest("form")
        .find("." + getName)
        .parents(".options_booleans")
        .find(".inputGrouping label");
      labels.addClass("checking");
      $(this)
        .closest("form")
        .find("." + slectedOpt)
  ...
  //check_multiple_response_answer
    ...
    var slectedOpiontings = $(this)
      .closest("form")
      .find(".multiple_boxes_answers")
      .val();
    var slectedOptings = $(this)
      .closest("form")
      .find(".multis_boxes_answers")
      .val();
    if (slectedOptings === slectedOpiontings) {
      ...
      labels = $(this)
        .closest("form")
        .find(".multis_boxes_answers")
        .parents(".multiple_checked_boxing")
        .find(".form-group .inputGrouping label");
      labels.addClass("checking");
      var arr = slectedOptings.split(",");
      arr.forEach((element) => {
        $(this)
    ...
    selectedValue.each(function (index) {
      var asnweer = $(this)
        .closest(".single_closest")
        .find(".multi_mcqting_answer")
        .val();
      var asnweers = $(this)
        .closest(".single_closest")
        .find(".mcqing-answers")
...
$(document).on("click", ".mcq_checked", function () {
  if ($("div[data-is-lerner=true]").length > 0) {
    if ($(this).prop("checked") == true) {
      ...
      var val2 = $(this)
        .closest("div.multi-blank-div")
        .find("input[data-multiblank-answer=" + radio_btn_name + "]")
        .val(id);
    }
  } else {
    if ($(this).prop("checked") == true) {
      ...
      var val1 = $(this)
        .closest("div.multi-blank-div")
        .find("input[data-multiblank-answers=" + radio_btn_name + "]")
        .val(id);
...
$(document).on("click", ".quiz-submit-answer", function (event) {
  ...
  var ref_id = $(this)
    .closest("form")
    .find("input[name=question_ref_id]")
    .val();
  var label_values = [];
    ...
    if (questions[i].key.ref_id == ref_id) {
      ...
      if (questions[i].key.options.length > 0) {
        for (var j = 0; j < questions[i].key.options.length; j++) {
          ...
          if (
            questions[i].key.options[j].option.length > 0 &&
            jQuery.inArray(option_name, label_values)
          ) {
  ...
  $.ajax({
    ...
    headers: {
      "X-Auth-Token":
        "",
  ...
  $(this)
    ...
    .parent()
    .find("button:eq(1)")
    .addClass("bolean_view_correct_option");
  $(this)
    .parent()
    .parent()
    .parent()
...
$(document).on("click", ".btn-add-option-multi", function (e) {
  ...
  var last_row = $(this)
    .closest(".multi-blank-div")
    .find("div.add-more-row:last")
    .find("input.data-row-number")
    .val();
  ...
  var html =
    ...
    '<input type="hidden" name="data_row_number" class="data-row-number" value="' +
    new_input_text +
    '" />' +
    ...
    '" name="' +
    input_name +
    '" type="radio" data-id ="2" class="mcq_checked"/>' +
    '<label class="' +
    new_input +
    '" for="' +
    new_input +
    '" data-editable="true" contenteditable="true">Option ' +
    new_input_text +
    "</label>" +
    "</div>" +
    "</div>" +
...
$(document).on("click", ".add_new_blank", function (e) {
  ...
  $(this)
    .closest("form")
    .find(".blank-heading-attach")
    .html(
      prevval +
        '<span contentEditable="false" contenteditable="false" data-id= ' +
        new_input +
        ' class="line_remove_blan"><span class="iconify tutor_iconify" contentEditable="false" contenteditable="false"  data-icon="ant-design:line-outlined"></span></span> '
    );

  var html =
    '<div class="row multi-blank-div">' +
    '<input type="hidden" value="" data-multiblank-answers="' +
    blank_name +
    '" name="multiblank-answers[' +
    blank_name +
    ']" />' +
    '<input type="hidden" value="" data-multiblank-answer="' +
    blank_name +
    '" name="multiblank-answer[' +
    blank_name +
    ']" />' +
    ...
    '<h5 class="crt_option numbering_sort" contenteditable="true" data-editable="true">Blank ' +
    new_input_text +
    "</h5>" +
    "</div>" +
    "</div>" +
    '<div class="col-md-2">' +
    '<a href="#" class="btn btn-danger remove-field btn-remove-customer-two btn-remove-option-multi"  data-id=' +
    new_input +
    ' contenteditable="false" data-editable="false"><i class="fa fa-minus" aria-hidden="true"></i></a>' +
    "</div>" +
    '<div class="row add-more-row">' +
    ...
    '" for="' +
    new_input1 +
    '" data-editable="true" contenteditable="true">Option 1</label>' +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
    ...
    '" for="' +
    new_input2 +
    '" data-editable="true" contenteditable="true">Option 2</label>' +
    "</div>" +
    "</div>" +
    "</div>" +
    '<div class="col-md-2">' +
...
$(document).on("click", ".single_blank_add", function (e) {
  ...
  var html =
    ...
    '<input id="radio2-blank-' +
    new_input +
    '" name="radio" type="radio" data-id="' +
    new_input_text +
    '" class="radio_mul_checked"/>' +
    '<label class="radio2-blank" for="radio2-blank-' +
    new_input +
    '" data-editable="true" contenteditable="true">Option ' +
    new_input_text +
    "</label>" +
    ...
    "</div>" +
    "</div>" +
    '<div class="error col-md-9 mobile_screen_size offset-md-1" id=' +
...
$(document).on("click", ".add-checkbox-row", function (e) {
  ...
  var html =
    ...
    '<input id="option' +
    new_input +
    '" name="option" type="checkbox" value="Option ' +
    new_input +
    '" class="cbox_option" />' +
    '<label class="option2" for="option' +
    new_input +
    '"  data-editable="true" contenteditable="true">Option ' +
    new_input_text +
    "</label>" +
...
$(document).on("click", ".add-choice-row", function (e) {
  ...
  var html =
    ...
    new_input +
    '" class="radio_mul_checked"/>' +
    '<label class="radio2" for="radio' +
    new_input +
    '" contenteditable="true" data-editable="true">Option ' +
    new_input_text +
    "</label>" +
    "</div>" +
    "</div>" +
  ...
  snippets: [
    ...
    },
    {
      ...
      html:
        ...
        '<div class="col-md-12">' +
        '<div class="acie_ment subjective_question quiz-questionnaire" id=' +
    ...
    },
    {
      ...
      html:
        '<div class="row clearfix" data-editable="false" contenteditable="false">' +
        '<div class="col-md-12">' +
        '<div class="quiz-questionnaire" id=' +
    ...
    },
    {
      ...
      html:
        ...
        '<div class="col-md-12">' +
        '<div class="acie_ment option_boolean_one quiz-questionnaire"  id=' +
    ...
    },
    {
      ...
      html:
        '<div class="row clearfix"  data-editable="false" contenteditable="false">' +
        '<div class="col-md-12">' +
        '<div class="acie_ment quiz-questionnaire tutor_acient tutor_main_checked_select" id=' +
    ...
    },
    {
      ...
      html:
        '<div class="row clearfix"  data-editable="false" contenteditable="false">' +
        '<div class="col-md-12">' +
        '<div class="acie_ment quiz-questionnaire subjective_question " id=' +
    ...
    },
    {
      ...
      html:
        '<div class="row clearfix"  data-editable="false" contenteditable="false">' +
        '<div class="col-md-12">' +
        '<div class="acie_ment quiz-questionnaire multiple_fill_option" id=' +
        Math.floor(Math.random() * 1000) +
        ">" +
        ...
        }, */
    {
      ...
      html:
        ...
        encodeURIComponent(
          "<h2>My Custom Module</h2> <p> Click setting to change</p>"
        ) +
        '" data-settings="">' +
        "</div>" +
        "</div>",
